...
try {
    ...
    $sql = "CREATE DATABASE IF NOT EXISTS despesasteste";
    $pdo->exec($sql);

    echo "Banco de dados 'despesasteste' criada com sucesso\n";

    $sql = "USE despesasteste";
    $pdo->exec($sql);

    echo "Novo banco de dados sendo usado\n";
    ...
    $pdo->exec($sql);
    echo "Tabela 'transacoes' criada com sucesso\n";

    $sql = "INSERT INTO usuarios (id, nome, senha, email, user_level) VALUES 
    ...
    $pdo->exec($sql);
    echo "Dados inseridos na tabela 'usuarios' com sucesso\n";

    $sql = "INSERT INTO categorias (id, nome, tipo, usuario_id) VALUES 
    ...
    $pdo->exec($sql);
    echo "Dados inseridos na tabela 'categorias' com sucesso\n";

    $sql = "INSERT INTO transacoes (tipo, descricao, valor, categoria_id, usuario_id, data_transacao) VALUES
    ...
    $pdo->exec($sql);
    echo "Dados inseridos na tabela 'transacoes' com sucesso\n";
